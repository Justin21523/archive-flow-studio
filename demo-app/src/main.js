...
const project = {
  ...
  "githubUrl": "https://github.com/Justin21523/archive-flow-studio",
  ...
  "features": [
    ...
    "SQLite and FTS5 provide local persistence and search"
  ],
  "metrics": [
    {
      "label": "Demo Modules",
  ...
  "records": [
    ...
    {
      "id": "flow-02",
      "name": "NET, Avalonia, SQLite, Dapper, FluentMigrator, ImageSharp, MVVM, Clean Architecture,README evidence exists and can support a fuller reviewed case study,A public GitHub repository is linked for source traceability",
      "status": "Review",
      "owner": "Data"
    },
    {
      "id": "flow-03",
      "name": "I designed a node-based workflow system where users can connect file sources, filters, metadata actions, relationship builders, and output nodes into repeatable processing pipelines",
      "status": "Queued",
      "owner": "Automation"
    },
    {
      "id": "flow-04",
      "name": "SQLite and FTS5 provide local persistence and search",
      "status": "Ready",
      "owner": "Product"
    }
  ]
